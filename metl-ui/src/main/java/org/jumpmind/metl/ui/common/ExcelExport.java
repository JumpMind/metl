...
public class ExcelExport<T> {
    ...
    public ExcelExport(final IDataProvider<T> gridData) {
        this(gridData, new HSSFWorkbook(), null, null);
    }

    public ExcelExport(final IDataProvider<T> gridData, String sheetName) {
        this(gridData, new HSSFWorkbook(), sheetName, null);
    }

    public ExcelExport(final IDataProvider<T> gridData, String sheetName, String title) {
        this(gridData, new HSSFWorkbook(), sheetName, title, null);
    }

    public ExcelExport(final IDataProvider<T> gridData, String sheetName, String title, String fileName) {
        this(gridData, new HSSFWorkbook(), sheetName, title, fileName);
    }

    public ExcelExport(final IDataProvider<T> gridData, HSSFWorkbook wkbk) {
        this(gridData, wkbk, null, null, null);
    }

    public ExcelExport(final IDataProvider<T> gridData, HSSFWorkbook wkbk, String sheetName) {
        this(gridData, wkbk, sheetName, null, null);
    }

    public ExcelExport(final IDataProvider<T> gridData, HSSFWorkbook wkbk, String sheetName, String title) {
        this(gridData, wkbk, sheetName, title, null);
    }

    public ExcelExport(final IDataProvider<T> gridData, HSSFWorkbook wkbk, String sheetName, String title, String fileName) {
    ...
    public ExportFileDownloader getFileDownloader() {
        ...
        try {
            ...
            return new ExportFileDownloader(fileName, excelMimeContentType, file);
        } catch (Exception e) {
            log.error("", e);
            return null;
        } finally {
    ...
    public void convertToExcel() {
        ...
        while (iterator.hasNext()) {
            ...
            HSSFCellStyle style = createDefaultStyle();
            int colCount = 0;
    ...
    public int addHeaders(int lastIndex) {
        ...
        int colCount = 0;
        HSSFCellStyle style = createHeaderStyle();
