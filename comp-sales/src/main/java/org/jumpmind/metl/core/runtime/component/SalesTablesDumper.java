...
public class SalesTablesDumper extends AbstractComponentRuntime {

    public final static String TYPE = "Sales Tables Dumper";
    ...
    public void handle(Message inputMessage, ISendMessageCallback callback, boolean unitOfWorkBoundaryReached) {
        callback.sendTextMessage(null, "Hello world!");
    }
}
