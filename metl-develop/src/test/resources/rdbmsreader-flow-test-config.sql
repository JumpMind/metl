...
DELETE FROM METL_COMPONENT_ATTRIB_SETTING WHERE COMPONENT_ID IN (SELECT ID FROM METL_COMPONENT WHERE PROJECT_VERSION_ID='de12fc2b-e9f2-4f8d-8dd5-682af7083e21' ) AND ATTRIBUTE_ID in (SELECT ID FROM METL_MODEL_ATTRIB WHERE ENTITY_ID IN (SELECT ID FROM METL_MODEL_ENTITY WHERE MODEL_ID IN (SELECT ID FROM METL_RELATIONAL_MODEL WHERE PROJECT_VERSION_ID='de12fc2b-e9f2-4f8d-8dd5-682af7083e21' )));
...
DELETE FROM METL_MODEL_ATTRIB WHERE ENTITY_ID IN (SELECT ID FROM METL_MODEL_ENTITY WHERE MODEL_ID in (SELECT ID FROM METL_RELATIONAL_MODEL WHERE PROJECT_VERSION_ID='de12fc2b-e9f2-4f8d-8dd5-682af7083e21' ));
DELETE FROM METL_MODEL_ENTITY WHERE MODEL_ID in (SELECT ID FROM METL_RELATIONAL_MODEL WHERE PROJECT_VERSION_ID='de12fc2b-e9f2-4f8d-8dd5-682af7083e21' );
DELETE FROM METL_RELATIONAL_MODEL WHERE PROJECT_VERSION_ID='de12fc2b-e9f2-4f8d-8dd5-682af7083e21' ;
...
insert into METL_RELATIONAL_MODEL (ID, ROW_ID, PROJECT_VERSION_ID, DELETED, NAME, SHARED, FOLDER_ID, CREATE_TIME, CREATE_BY, LAST_UPDATE_BY, LAST_UPDATE_TIME) values ('7112cb2c-5966-4e1d-b314-4936a56e9495','108dabf4-31c1-44fe-81e1-a7851974d31f','de12fc2b-e9f2-4f8d-8dd5-682af7083e21',0,'model1',0,null,{ts '2015-12-02 07:58:11.501'},null,null,{ts '2015-12-02 07:58:15.030'});
