...
DELETE FROM METL_COMPONENT_ATTRIBUTE_SETTING WHERE COMPONENT_ID IN (SELECT ID FROM METL_COMPONENT WHERE PROJECT_VERSION_ID='de12fc2b-e9f2-4f8d-8dd5-682af7083e21' ) AND ATTRIBUTE_ID in (SELECT ID FROM METL_MODEL_ATTRIBUTE WHERE ENTITY_ID IN (SELECT ID FROM METL_MODEL_ENTITY WHERE MODEL_ID IN (SELECT ID FROM METL_MODEL WHERE PROJECT_VERSION_ID='de12fc2b-e9f2-4f8d-8dd5-682af7083e21' )));
...
insert into METL_PROJECT_VERSION (ID, VERSION_LABEL, PROJECT_ID, ORIG_VERSION_ID, DESCRIPTION, READ_ONLY, ARCHIVED, DELETED, CREATE_TIME, CREATE_BY, LAST_UPDATE_BY, LAST_UPDATE_TIME) values ('de12fc2b-e9f2-4f8d-8dd5-682af7083e21','1.0','58241332-d21d-4ddf-8e79-0a624ad63c20',null,null,0,0,0,{ts '2015-12-02 07:56:34.106'},null,null,{ts '2015-12-02 07:56:34.107'});
