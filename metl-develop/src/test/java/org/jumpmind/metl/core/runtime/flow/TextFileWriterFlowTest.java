...
public class TextFileWriterFlowTest {

    static StandaloneTestFlowRunner standaloneFlowRunner;

    FlowName flow;

    public TextFileWriterFlowTest(FlowName flow) {
        this.flow = flow;
    }
    ...
    public static Collection<Object[]> getFlows() throws Exception {
        standaloneFlowRunner = new StandaloneTestFlowRunner("/textfilewriter-flow-test-config.json");
