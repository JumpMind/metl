...
public class RdbmsReaderFlowTest {

    static StandaloneTestFlowRunner standaloneFlowRunner;

    FlowName flow;

    public RdbmsReaderFlowTest(FlowName flow) {
        this.flow = flow;
    }
    ...
    public static Collection<Object[]> getFlows() throws Exception {
        standaloneFlowRunner = new StandaloneTestFlowRunner("/rdbmsreader-flow-test-config.sql");
