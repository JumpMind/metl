...
public class DelimitedFormatterFlowTest {

    static StandaloneTestFlowRunner standaloneFlowRunner;

    FlowName flow;

    public DelimitedFormatterFlowTest(FlowName flow) {
        this.flow = flow;
    }
    ...
    public static Collection<Object[]> getFlows() throws Exception {
        standaloneFlowRunner = new StandaloneTestFlowRunner("/delimited-formatter-flow-test-config.json");
