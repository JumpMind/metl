...
public class GroovyScriptFlowTest {

    static StandaloneTestFlowRunner standaloneFlowRunner;

    FlowName flow;

    public GroovyScriptFlowTest(FlowName flow) {
        this.flow = flow;
    }
    ...
    public static Collection<Object[]> getFlows() throws Exception {
        standaloneFlowRunner = new StandaloneTestFlowRunner("/groovyscript-flow-test-config.json");
