...
public class TestUtils {
    ...
    public static FlowStep createNoOpProcessorFlowStep(FlowVersion flowVersion, String name,
            Folder folder) {

        Component component = createComponent(NoOpProcessor.TYPE, false);
        ComponentVersion componentVersion = createComponentVersion(component, null, null, null,
    ...
    public static ComponentVersion createComponentVersion(Component component, Resource resource,
        ...
        ComponentVersion componentVersion = new ComponentVersion(component, resource,
