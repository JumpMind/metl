...
public class S3 extends AbstractResourceRuntime {
    ...
    public <T> T reference() {
        /* XXX: seems consistent w/r/t Sftp and Http, but confirm correct */
    ...
    private S3Directory createS3Directory(final TypedProperties properties) {
        ...
        String bucketName = properties.get(BUCKET_NAME, "").trim();
        if (bucketName == null || bucketName.isEmpty()) {
            throw new MisconfiguredException(BUCKET_NAME);
        }
    ...
    private ClientSideCrypto createClientSideCrypto(final TypedProperties properties,
        ...
        String defaultRegion = properties.is(USE_REGION_AS_CRYPTO_DEFAULT, false) ? s3Region
