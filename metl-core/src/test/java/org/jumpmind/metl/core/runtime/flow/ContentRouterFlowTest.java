...
public class ContentRouterFlowTest {

    static StandaloneTestFlowRunner standaloneFlowRunner;

    FlowName flow;

    public ContentRouterFlowTest(FlowName flow) {
        this.flow = flow;
    }
    ...
    public static Collection<Object[]> getFlows() throws Exception {
        standaloneFlowRunner = new StandaloneTestFlowRunner("/contentrouter-flow-test-config.sql");
