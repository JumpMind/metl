...
public class MessageTestHelper {
	...
	public static void addControlMessage(AbstractComponentRuntimeTestSupport testComponent, 
			String originatinStepId, boolean unitOfWorkBoundaryReached) {
	...
	public static void addInputMessage(AbstractComponentRuntimeTestSupport testComponent, boolean unitOfWorkLastMessage, boolean unitOfWorkBoundaryReached,
		...
		Message message = new MessageBuilder(originatinStepId)
				.withUnitOfWorkLastMessage(unitOfWorkLastMessage)
	...
	public static void addInputMessage(AbstractComponentRuntimeTestSupport testComponent, boolean unitOfWorkLastMessage, boolean unitOfWorkBoundaryReached,
		...
		Message message = new MessageBuilder(originatinStepId)
				.withUnitOfWorkLastMessage(unitOfWorkLastMessage)
				.withPayloadString(payload).build();
	...
	public static void addOutputMonitor(AbstractComponentRuntimeTestSupport testComponent, 
			int startMessageCount, int shutdownMessageCount) {
